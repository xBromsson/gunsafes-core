<?php
/**
 * Applies saved parent-category child term ordering to a specific JetEngine terms query.
 *
...
if ( ! class_exists( 'GScore_Jet_Engine_Category_Child_Order' ) ) {
	class GScore_Jet_Engine_Category_Child_Order {
		private const QUERY_ID = 3;
